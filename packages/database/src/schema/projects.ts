...
export const projectBudgets = pgTable("project_budgets", {
  ...
  laborBudget: decimal("labor_budget", { precision: 15, scale: 2 }).default("0"),
  materialBudget: decimal("material_budget", { precision: 15, scale: 2 }).default("0"),
  overheadBudget: decimal("overhead_budget", { precision: 15, scale: 2 }).default("0"),
  contingencyBudget: decimal("contingency_budget", { precision: 15, scale: 2 }).default("0"),
...
export const projectBudgetCategories = pgTable("project_budget_categories", {
  id: uuid("id").primaryKey().defaultRandom(),
  budgetId: uuid("budget_id").references(() => projectBudgets.id).notNull(),
...
export const projectCosts = pgTable("project_costs", {
  ...
  budgetCategoryId: uuid("budget_category_id").references(() => projectBudgetCategories.id),
  ...
  invoiceId:"invoice_id"), // Reference to invoice when billed
...
export const projectRevenue = pgTable("project_revenue", {
  ...
  recognizedAmount: decimal("recognized_amount", { precision: 15, scale: 2 }).default("0"),
  ...
  recognitionMethod: varchar("recognition_method", { length: 50 }).default("Percentage"), // Percentage, Milestone, Completed
  recognitionPercentage: decimal("recognition_percentage", { precision: 5, scale: 2 }).default("0"),
  notes: text("notes"),
  createdBy: uuid("created_by").references(() => users.id).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
...
export const projectInvoiceLineItems = pgTable("project_invoice_line_items", {
  id: uuid("id").primaryKey().defaultRandom(),
  invoiceId: uuid("invoice_id").references(() => projectInvoices.id).notNull(),
  taskId: uuid("task_id").references(() => projectTasks.id),
...
export const projectProfitability = pgTable("project_profitability", {
  ...
  overheadCosts: decimal("overhead_costs", { precision: 15, scale: 2 }).default("0"),
  budgetVariance: decimal("budget_variance", { precision: 15, scale: 2 }).default("0"),
  scheduleVariance: decimal("schedule_variance", { precision: 5, scale: 2 }).default("0"), // Percentage
  ...
  costPerformanceIndex: decimal("cost_performance_index", { precision: 5, scale: 4 }).default("1"),
  schedulePerformanceIndex: decimal("schedule_performance_index", { precision: 5, scale: 4 }).default("1"),
  estimateAtCompletion: decimal("estimate_at_completion", { precision: 15, scale: 2 }),
  estimateToComplete: decimal("estimate_to_complete", { precision: 15, scale: 2 }),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
...
export const projectBudgetCategoriesRelations = relations(projectBudgetCategories, ({ one, many }) => ({
...
export const projectInvoiceLineItemsRelations = relations(projectInvoiceLineItems, ({ one }) => ({
...
export const projectProfitabilityRelations = relations(projectProfitability, ({ one }) => ({
  project: one(projects, {
