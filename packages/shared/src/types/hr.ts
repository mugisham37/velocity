...
export const UpdateEmployeeDocumentSchema = CreateEmployeeDocumentSchema.partial().omit({
  employeeId: true,
});
...
export type CreateEmployeeDocumentDto = z.infer<typeof CreateEmployeeDocumentSchema>;
export type UpdateEmployeeDocumentDto = z.infer<typeof UpdateEmployeeDocumentSchema>;

export type CreateOnboardingTemplateDto = z.infer<typeof CreateOnboardingTemplateSchema>;
export type CreateOnboardingTaskDto = z.infer<typeof CreateOnboardingTaskSchema>;
export type CreateEmployeeOnboardingDto = z.infer<typeof CreateEmployeeOnboardingSchema>;
export type UpdateOnboardingTaskStatusDto = z.infer<typeof UpdateOnboardingTaskStatusSchema>;
