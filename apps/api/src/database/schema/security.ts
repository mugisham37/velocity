...
export const complianceFindingsRelations = relations(
  complianceFindings,
  ({ one }) => ({
...
export const dataSubjectsRelations = relations(
  dataSubjects,
  ({ one, many }) => ({
    company: one(companies, {
...
export const dataProcessingActivitiesRelations = relations(
...
export const privacyImpactAssessmentsRelations = relations(
...
export const securityConfigurationsRelations = relations(
